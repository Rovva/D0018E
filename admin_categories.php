            ...
            <table style="width: 100%;">
                ...
                <?php
                    ...
                    <form action="admin_categories.php">
                        ...
                        <th></th>
                        <th style="text-align: left;"><input type="button" name="edit" value="Edit category"></th>
                        <th style="text-align: left;"><input type="button" name="remove" value="Remove category"></th>
                    </form>
                </tr>';
                    }
                ?>
                    <tr>
                        <form action="admin_categories.php">
                        <th><input type="button" name="add" value="Add category"></th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
